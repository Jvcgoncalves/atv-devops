...
import ClimatizadorPanel from "../components/ClimatizadorPanel.tsx";
import BathroomExhaust from "../components/BathroomExhaust.tsx";
import TelemetryChart from "../components/TelemetryChart.tsx";
import { STATUS, palette } from "../theme.ts";
import type { Room, Status } from "@hvac/contracts";
...
export default function DashboardPage() {
  ...
  const criticas = salas.filter((s: Room) => Object.values(s.status).includes(STATUS.CRITICO as Status)).length;
